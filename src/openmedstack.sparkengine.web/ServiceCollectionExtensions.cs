...
public static class ServiceCollectionExtensions
{
        ...
        where T : FhirController
    {
        ...
        services.TryAddSingleton(new FhirJsonPocoSerializer());
        services.TryAddSingleton(new FhirJsonPocoDeserializer());
        services.TryAddSingleton(new FhirXmlSerializer());
        services.TryAddSingleton(new FhirXmlPocoSerializer());
        services.TryAddSingleton(new FhirXmlPocoDeserializer());
        services.TryAddSingleton(new FhirJsonParser());
        services.TryAddSingleton(new FhirXmlParser());
