...
//            if (_endpoint != null && _endpoint.Count() > 0)
//            {
//                messaging.Endpoint = _endpoint;
//            }

//            if (_reliableCache != null)
//            {
//                messaging.ReliableCacheElement = _reliableCache;
//            }

//            if (_documentation != null)
//            {
//                messaging.Documentation = _documentation;
//            }

//            if (_supportedMessage != null && _supportedMessage.Count() > 0)
//            {
//                messaging.SupportedMessage = _supportedMessage;
//            }
...
//            if (_endpoint == null)
//            {
//                _endpoint = new List<EndpointComponent>();
//            }
...
//            {
//                _supportedMessage = new List<SupportedMessageComponent>();
//            }
...
//            {
//                _supportedMessage.Add(supportedMessage);
//            }
