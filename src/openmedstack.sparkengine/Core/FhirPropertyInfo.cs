...
public class FhirPropertyInfo
{
    ...
    /// </summary>
    public List<Type> AllowedTypes { get; } = new();
    ...
    public IEnumerable<string> TypedNames { get; internal set; } = Enumerable.Empty<string>();
    ...
    /// </summary>
    public PropertyInfo PropInfo { get; internal set; } = null!;
}