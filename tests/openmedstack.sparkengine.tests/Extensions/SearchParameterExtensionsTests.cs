...
//        {
//            var sut = new SearchParameter { Base = new List<AllResourceTypes?> { AllResourceTypes.Appointment } };
...
//        {
//            var sut = new SearchParameter { Base = new List<AllResourceTypes?> { AllResourceTypes.AuditEvent } };
...
//        {
//            var sut = new SearchParameter { Base = new List<AllResourceTypes?> { ResourceType.Slot } };
